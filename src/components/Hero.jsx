    ...
    <section id="home" className="min-h-screen section-padding">
      <div className="flex flex-col items-center text-center justify-center gap-5">
        <img
          ...
          alt="profile"
        />
        <h1 className="mt-4 w-72 md:w-xl lg:w-3xl xl:w-4xl text-3xl md:text-6xl font-extrabold md:font-bold">
        ...
        <p className="text-center text-[16px] sm:text-[18px] md:px-8 w-72 md:w-xl xl:w-3xl xl:text-xl">
          I’m a MERN Stack Web Developer, passionate about building impactful
          applications and continuously enhancing my skills to create innovative
          digital solutions. 🚀
        </p>
